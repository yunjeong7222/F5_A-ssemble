        ...
        <div className="auth-modal-overlay">
            <div className="auth-modal">
                <div className="auth-modal-body">
                    {step === 1 && (
                        <>
                            ...
                            <p className="auth-modal-desc">
                                가입 시 사용한 <span className="pri">이메일과 닉네임</span>이 정확히 일치하면
                                <br />
                                임시 비밀번호를 발급해드립니다.
                            </p>
                            <p className="auth-modal-desc-m">아이디찾기는 조금만 기다려주세요!</p>
                            <input
                                type="email"
                            ...
                            />
                            <div className="check-fail-box">
                                {errorMsg && <p className="check-fail-msg">{errorMsg}</p>}
                            </div>
                        </>
                    )}
                    ...
                    {step === 2 && (
                        <>
                            ...
                            <p className="auth-modal-result-warning">로그인 후 반드시 비밀번호를 변경해주세요.</p>
                            ...
                            <p className="auth-modal-desc" style={{margin: '24px 0'}}>
                                임시 비밀번호로 로그인 후<br />
                                마이페이지 → 보안 설정에서 변경 가능합니다.
                            </p>
                        </>
                    )}
                </div>
                ...
                <div className="auth-modal-footer">
                    {step === 1 && (
                        <>
                            <button className="auth-modal-btn-cancel" onClick={onClose}>
                                취소
                            </button>
        ...
        <div className="auth-page auth-page-col">
            ...
            <div className="auth-page-login">
                ...
                <form onSubmit={handleLogin} noValidate>
                    <div className="auth-form-group login-input-margin1">
                        <input
                    ...
                    <div className="auth-form-group login-input-margin2 login-input-wrapper">
                        <input
                            className="auth-input"
                            type="password"
                            placeholder="비밀번호"
                    ...
                    <div className="auth-error-area">{message && <p className="auth-error-msg">{message}</p>}</div>

                    <button type="submit" className="auth-btn-primary" disabled={isLoading}>
                        {isLoading ? '로그인 중' : '로그인'}
                    </button>
                    <div className="login-forgot-row">
                        <button type="button" className="login-forgot-link" onClick={() => setIsModalOpen(true)}>
                            아이디 찾기 | 비밀번호 찾기
                        </button>
                    </div>
                    <div className="auth-redirect">
                        <p className="auth-need">기존 회원이 아니신가요?</p>
