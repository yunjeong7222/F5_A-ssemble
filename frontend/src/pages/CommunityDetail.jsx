            ...
            try {
                ...
                if (postData.workflow_id) {
                    ...
                    const steps = (resultJson?.steps || []).map((s) => ({
                        ...
                        thumbnail:
                            wfData.tools?.find((t) => t.tool_name === (s.tool_name ?? s.tool))?.thumbnail || null,
                    }));
                    ...
                    steps.forEach((s) => {
                        initialPrompts[s.step] = s.prompt_example;
                    });
                ...
                <section>
                            ...
                            <div className="write-flow-wrap">
                                {workflow.steps.map((step, index) => (
                                    <React.Fragment key={step.step}>
                                        ...
                                        {index < workflow.steps.length - 1 && <div className="write-flow-arrow">➔</div>}
                                    </React.Fragment>
                                ))}
                            </div>
                        </div>
                    ...
                    {workflow.steps.length > 0 && (
                        <div className="write-prompt-area">
                            <h5 className="write-cat-title" style={{marginBottom: 20}}>
                                단계별 프롬프트
                            </h5>
