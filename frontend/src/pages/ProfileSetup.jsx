...
const ProfileSetup = () => {
    ...
    const handleComplete = async () => {
        ...
        try {
            ...
            await Alert.fire({text: '회원가입이 완료되었습니다! 로그인 후 서비스를 이용해주세요.'});
            ...
            await Alert.fire({text: '프로필 사진 처리 중 오류가 발생했습니다.'});
                ...
                <div className="auth-split-right">
                    ...
                    <div className="setup-info-card">
                        ...
                        <div className="setup-info-row">
                            ...
                            <span
                                className={`setup-info-value${signupData?.marketingAgreed ? ' setup-info-value--ok' : ' setup-info-value--off'}`}
                            >
                    ...
                    <button className="auth-btn-outline" onClick={() => navigate('/login')}>
                        로그인
                    </button>
                </div>
            </div>
