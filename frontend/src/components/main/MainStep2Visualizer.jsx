        ...
        <div className={`${styles['vis-mockup-wrapper']} ${styles['vis-step2-wrapper']}`}>
            <div className={styles['vis-workflow-container']}>
                <div style={{padding: '0 30px'}}>
                    <h2
                        className={styles['wf-step2-title']}
                        style={{textAlign: 'left', fontSize: '1.25rem', lineHeight: '1.4', color: 'white'}}
                    >
                        "여행 브이로그 편집할 건데 무료 AI 툴 추천해줘"에 추천하는 AI 툴 조합이에요. 사용하실 툴을
                        선택하세요.
                    </h2>

                    <div className={styles['ts-container']} style={{padding: '0', marginTop: '30px'}}>
                        <div className={styles['ts-flow-container']}>
                            <div className={`${styles['ts-flow-step']} ${styles['vis-flow-step-1']}`}>
                                <div className={styles['ts-flow-category']} style={{color: '#8b5cf6'}}>
                                    기획 및 스크립트
                                </div>
                            ...
                            <div className={`${styles['ts-flow-step']} ${styles['vis-flow-step-2']}`}>
                                <div className={styles['ts-flow-category']} style={{color: '#10b981'}}>
                                    영상 소스 생성
                                </div>
                                <div className={styles['ts-flow-tool']}>
                            ...
                            <div className={`${styles['ts-flow-step']} ${styles['vis-flow-step-3']}`}>
                                ...
                                <div className={styles['ts-flow-tool']}>
                                    <span className={styles['vis-flow-empty-3']}>미선택</span>
                            ...
                            <div className={`${styles['vis-grid-page']} ${styles['vis-page-1']}`}>
                                ...
                                >
                                    <div className={styles['ts-card']}>
                                        ...
                                        <div className={styles['ts-specialized']} style={{color: '#8b5cf6'}}>
                                    ...
                                    <div className={`${styles['ts-card']} ${styles['vis-target-1']}`}>
                                        ...
                                        <div className={styles['ts-specialized']} style={{color: '#8b5cf6'}}>
                                            ✦ 인간적인 문체와 문맥 이해가 뛰어난 감성 에디터. 스토리 설계와 감성
                                            브이로그 대본 작성에 최적
                                        </div>
                                    </div>
                            ...
                            <div className={`${styles['vis-grid-page']} ${styles['vis-page-2']}`}>
                                ...
                                >
                                    <div className={styles['ts-card']}>
                                        ...
                                        <div className={styles['ts-specialized']} style={{color: '#10b981'}}>
                                    ...
                                    <div className={styles['ts-card']}>
                                        ...
                                        <div className={styles['ts-specialized']} style={{color: '#10b981'}}>
                                            ✦ 빠른 생성 속도와 자연스러운 카메라 무빙이 강점인 영상 생성 툴.
                                            텍스트·이미지 → 영상 변환 지원
                                        </div>
                                    </div>
                            ...
                            <div className={`${styles['vis-grid-page']} ${styles['vis-page-3']}`}>
                                ...
                                >
                                    <div className={`${styles['ts-card']} ${styles['vis-target-3']}`}>
                                        ...
                                        <div className={styles['ts-specialized']} style={{color: '#f59e0b'}}>
